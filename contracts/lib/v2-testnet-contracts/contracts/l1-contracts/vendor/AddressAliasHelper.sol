...
library AddressAliasHelper {
    ...
    function actualRefundRecipient(address _refundRecipient, address _originalCaller)
        internal
        view
        returns (address _recipient)
    {
        if (_refundRecipient == address(0)) {
            ...
            _recipient =
                _originalCaller == tx.origin ? _originalCaller : AddressAliasHelper.applyL1ToL2Alias(_originalCaller);

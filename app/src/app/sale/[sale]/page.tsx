...
export default function SalePage({ params }: { params: { sale: string } }) {
  ...
  if (error || !saleDetails) return <div className="p-4 border rounded">Error loading sale</div>;
  ...
  const handleBuy = async () => {
    ...
    try {
      ...
      const isNative = saleDetails.paymentToken === "0x0000000000000000000000000000000000000000";
    ...
    <div className="max-w-3xl mx-auto py-10 px-4 space-y-8">
      ...
      <div className="flex gap-6">
        ...
        <div className="space-y-2 text-sm">
          <p>
            <strong>Sale Address:</strong> {saleDetails.sale}
          </p>
          <p>
          ...
          <p>
            <strong>Ends:</strong> {new Date(saleDetails.end * 1000).toLocaleString()}
          </p>
          <p>
